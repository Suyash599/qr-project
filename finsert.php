...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query=mysqli_query($con,"Select * from fregister");
    ...
    while($row = mysqli_fetch_array($query)) 
    {
        ...
        if($register_number == $table_users) 
        {
            ...
            Print '<script>window.location.assign("fregister.html");</script>'; 
        }
    }
    if($bool) 
    {
        mysqli_query($con,"INSERT INTO fregister (register_number,username,password,proctor_name,email,phone) VALUES ('$register_number','$username','$password','$proctor_name','$email','$phone')"); 
